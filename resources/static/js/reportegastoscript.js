		...
		const listUsers = async () => {
			try {
				...
				datos.forEach((dato) =>
				{
					...
					content += `
						<tr>
							<td class="centered">${dato.codCompra}</td>
							<td class="centered">${dato.fechaCompra}</td>
							<td class="centered">${dato.tipoComprobante}</td>
							<td class="centered">${dato.monto}</td>
