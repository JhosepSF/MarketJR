		...
		buttons: [     
			{
				...
				filename: 'Reporte Ingreso Diario',
	...
	const listUsers = async () => 
	{
		...
		try 
		{
			...
			datos.forEach((dato) =>
			{
				content += `
					<tr>
						<td class="centered">${dato.ventaId}</td>
						<td class="centered">${dato.fecha}</td>
						<td class="centered">${dato.hora}</td>
						<td class="centered">${dato.monto}</td>
						<td class="centered">${dato.tipoComprobante}</td>
						<td class="centered">${dato.metodo}</td>
						<td class="centered">${dato.empleadonombre}</td>
					</tr>`;
			});
